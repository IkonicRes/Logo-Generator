...
describe('Circle', () => {
 //TODO: Write circle test  
    test('render method should return SVG string with the given shape color', () => {
        ...
        shape.setColor('blue')
        expect(shape.render('circle')).toEqual('  <circle cx="150" cy="100" r="80" fill="blue" />')
    }) 
})
describe('Square', () => {
    ...
    test('render method should return SVG string with the given shape color', () => {
        ...
        shape.setColor('blue')
        expect(shape.render('square')).toEqual('  <rect x="40" y="40" width="120" height="120" fill="blue" />')
        })
})